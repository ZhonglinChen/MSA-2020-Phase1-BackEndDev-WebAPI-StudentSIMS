...
- StudentController: 
  ...
  `POST: api/Students` - `PostStudent(Student student)`
...
- StudentController: 
  ...
  `PUT: api/Students/:id` - `PostStudent(int id, [Bind("...")]Student student)`
...
- StudentController: 
  ...
  `DELETE: api/Students/:id` - `DeleteStudent(int id)`
...
- AddressController: 
  ...
  `GET: api/addresses/:id` - `GetAddress(int id)`
...
- AddressController: 
  ...
  `Post: api/addresses` - `PostAddress(Address address)`
...
- AddressController: 
  ...
  `Put: api/addresses/:id` - `PutAddress(int id, Address address)`
...
- AddressController: 
  ...
  `DELETE: api/addresses/:id` - `DeleteAddress(int id)`
